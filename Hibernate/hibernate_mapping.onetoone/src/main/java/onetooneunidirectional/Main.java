...
public class Main {
	public static void main(String[] args) {
		...
		// Step 4: Create and set up the Question object
		Question q = new Question();
		q.setQname("How Are You?");

		// Step 5: Create and set up the Answer object
		Answer ans = new Answer();
		ans.setAid(101);
		ans.setAname("I am Fine");

		// Step 6: Set the answer for the question (unidirectional relationship)
		q.setAns(ans); // Extra column created in the Question table to hold the Answer's ID

		// Step 7: Save the Question and Answer objects to the database
		s.save(q);
		s.save(ans);
